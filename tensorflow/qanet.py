...
from layers.OurLayer import regularizer, residual_block, highway, conv, mask_logits, trilinear, total_params, \
    position_embedding
...
class Model(object):
    ...
    def _setup_placeholders(self):
        ...
        # print("p.shape:", self.c.shape)
        # print("q.shape:", self.q.shape)
        # print("ch.shape:", self.ch.shape)
        # print("qh.shape:", self.qh.shape)
        # print("p_length.shape:", self.c_len.shape)
        # print("q_length.shape:", self.q_len.shape)
    ...
    def _embed(self):
        ...
        # print("c_emb.shape:", self.c_emb.shape)
        # print("q_emb.shape:", self.q_emb.shape)
    ...
    def _encode(self):
        ...
        with tf.variable_scope("Embedding_Encoder_Layer"):
            ...
            self.q_embed_encoding = residual_block(self.q_emb,
                                                   ...
                                                   bias=False,
                                                   dropout=self.dropout)
        # print("sep_p_encodes.shape:", self.c_embed_encoding.shape)
        # print("sep_q_encodes.shape:", self.q_embed_encoding.shape)
    ...
    def _decode(self):
        ...
        print(" self.logits1:", self.logits1)
        print(" self.logits2:", self.logits2)
